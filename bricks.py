...
lvl3_bricks.append(sample)
sample = level3_brick(40,7)
lvl3_bricks.append(sample)
sample = level3_brick(40,8)
lvl3_bricks.append(sample)
sample = level1_brick(40,9)
lvl1_bricks.append(sample)
sample = level1_brick(40,10)
lvl1_bricks.append(sample)
sample = level1_brick(40,11)
lvl1_bricks.append(sample)
...
lvl1_bricks.append(sample)
sample = level1_brick(76,7)
lvl1_bricks.append(sample)
sample = level1_brick(76,8)
lvl1_bricks.append(sample)
...
def display_level3_brick():
    ...
    # sample = non_destructible_brick(45,6)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(51,6)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(57,6)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(63,6)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(69,6)
    # nond_bricks.append(sample)

    sample = non_destructible_brick(45,7)
    nond_bricks.append(sample)
    sample = non_destructible_brick(51,7)
    nond_bricks.append(sample)
    sample = non_destructible_brick(57,7)
    nond_bricks.append(sample)
    sample = non_destructible_brick(63,7)
    nond_bricks.append(sample)
    sample = non_destructible_brick(69,7)
    nond_bricks.append(sample)
    ...
    sample = non_destructible_brick(45,9)
    nond_bricks.append(sample)
    sample = non_destructible_brick(51,9)
    nond_bricks.append(sample)
    sample = non_destructible_brick(57,9)
    nond_bricks.append(sample)
    sample = non_destructible_brick(63,9)
    nond_bricks.append(sample)
    sample = non_destructible_brick(69,9)
    nond_bricks.append(sample)

    # sample = non_destructible_brick(42,9)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(48,9)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(54,9)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(60,9)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(66,9)
    # nond_bricks.append(sample)
    # sample = non_destructible_brick(72,9)
    # nond_bricks.append(sample)
